        ...
        <div class="flex justify-center items-center">
          <div class="container mx-auto my-4 px-4 lg:px-20">
            <div class="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
              <div class="flex">
                <h1 class="font-bold uppercase text-5xl text-[#CF8E69]">
              ...
              <div class="my-2 w-1/2 lg:w-1/4">
                <button
                  class="uppercase text-sm font-bold tracking-wide bg-black text-[#CF8E69] hover:bg-transparent duration-300 hover:outline-black outline p-3 rounded-lg w-full 
            ...
            <div class="w-full lg:-mt-96 lg:w-2/6 px-8 py-12 ml-auto bg-black rounded-2xl">
              <div class="flex flex-col text-[#CF8E69]">
